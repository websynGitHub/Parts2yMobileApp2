...
namespace YPS.Parts2y.Parts2y_View_Models
{
    public class PPartsInspectionQuestionsViewModel : IBase
    {
            ...
            AllPoData selectedtagdata, bool isalldone)
        {
            ...
            {
                YPSLogger.ReportException(ex, "PPartsInspectionQuestionsViewModel constructor -> in PPartsInspectionQuestionsViewModel " + Settings.userLoginID);
            ...
            try
            {
                ...
                if (Navigation.NavigationStack[2].GetType().Name.Trim().ToLower() == "POChildListPage".Trim().ToLower())
                {
                    if (Navigation.NavigationStack.Count > 3
                        && Navigation.NavigationStack[3].GetType().Name.Trim().ToLower() != "PPartsInspectionQuestionsPage".Trim().ToLower())
                    {
                        Navigation.RemovePage(Navigation.NavigationStack[3]);
                    }
                }
