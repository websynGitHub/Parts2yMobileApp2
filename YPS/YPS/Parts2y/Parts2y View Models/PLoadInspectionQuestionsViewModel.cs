...
{
    public class PLoadInspectionQuestionsViewModel : IBase
    {
        ...
        public PLoadInspectionQuestionsViewModel(INavigation _Navigation, PLoadInspectionQuestionsPage pagename, ObservableCollection<AllPoData> selectedpodatalist, bool isalltagdone)
        {
            try
            {
            ...
            {
                YPSLogger.ReportException(ex, "PLoadInspectionQuestionsViewModel constructor -> in PLoadInspectionQuestionsViewModel.cs " + Settings.userLoginID);
        ...
        public async Task TabChange(string tabname)
        {
            ...
            {
                YPSLogger.ReportException(ex, "TabChange method -> in PLoadInspectionQuestionsViewModel.cs " + Settings.userLoginID);
                var trackResult = trackService.Handleexception(ex);
            }
            finally
            {
        ...
        private async Task<ObservableCollection<AllPoData>> GetUpdatedAllPOData()
        {
            ...
            {
                loadindicator = true;
                YPSLogger.TrackEvent("PLoadInspectionQuestionsViewModel.cs", " in GetUpdatedAllPOData method " + DateTime.Now + " UserId: " + Settings.userLoginID);
            ...
            {
                YPSLogger.ReportException(ex, "GetUpdatedAllPOData method -> in PLoadInspectionQuestionsViewModel.cs " + Settings.userLoginID);
                var trackResult = trackService.Handleexception(ex);
            }
            finally
            {
        ...
        public async void LoadInspTabClicked()
        {
            try
            {
                ...
                await GetConfigurationResults(15);
            ...
            {
                YPSLogger.ReportException(ex, "LoadInspTabClicked method -> in PLoadInspectionQuestionsViewModel.cs " + Settings.userLoginID);
                var trackResult = trackService.Handleexception(ex);
            }
            finally
            {
        ...
        public async void SignTabClicked()
        {
            ...
            {
                YPSLogger.ReportException(ex, "SignTabClicked method -> in PLoadInspectionQuestionsViewModel.cs " + Settings.userLoginID);
                var trackResult = trackService.Handleexception(ex);
            }
            finally
            {
        ...
        public async Task GetConfigurationResults(int categoryID)
        {
            ...
            {
                YPSLogger.ReportException(ex, "GetConfigurationResults method -> in PLoadInspectionQuestionsViewModel.cs " + Settings.userLoginID);
                var trackResult = trackService.Handleexception(ex);
            }
            finally
            {
        ...
        public void GetQuestionsLIst()
        {
            ...
            {
                YPSLogger.ReportException(ex, "GetQuestionsLIst method -> in PLoadInspectionQuestionsViewModel.cs " + Settings.userLoginID);
                var trackResult = trackService.Handleexception(ex);
            }
        }
        ...
        public async Task Backevnttapped_click()
        {
            ...
            {
                YPSLogger.ReportException(ex, "Backevnttapped_click method -> in PLoadInspectionQuestionsViewModel.cs " + Settings.userLoginID);
                var trackResult = trackService.Handleexception(ex);
            }
        }
        ...
        public async void QuestionClick(InspectionConfiguration inspectionConfiguration)
        {
            try
            {
                ...
                await Navigation.PushAsync(new PInspectionAnswersPage(inspectionConfiguration, QuestionListCategory,
                    inspectionResultsLists, SelectedPodataList[0],
                    false, null, this, IsAllTagsDone, string.Join(",", EncPOTagID)), false);
            }
            catch (Exception ex)
            {
                YPSLogger.ReportException(ex, "QuestionClick method -> in PLoadInspectionQuestionsViewModel.cs " + Settings.userLoginID);
                var trackResult = trackService.Handleexception(ex);
            }
            finally
            {
        ...
        public async void ChangeLabel()
        {
            try
            {
                ...
                if (Settings.alllabeslvalues != null && Settings.alllabeslvalues.Count > 0)
                {
                    ...
                    if (labelval.Count > 0)
                    {
                        ...
                        var carrier = labelval.Where(wr => wr.FieldID.Trim().ToLower() == labelobj.CarrierInsp.Name.Trim().ToLower()).Select(c => new { c.LblText, c.Status }).FirstOrDefault();
                        ...
                        labelobj.CarrierInsp.Name = (carrier != null ? (!string.IsNullOrEmpty(carrier.LblText) ? carrier.LblText : labelobj.CarrierInsp.Name) : labelobj.CarrierInsp.Name);
            ...
            {
                YPSLogger.ReportException(ex, "ChangeLabel method -> in PLoadInspectionQuestionsViewModel.cs " + Settings.userLoginID);
                var trackResult = trackService.Handleexception(ex);
            }
            finally
            {
        ...
        public class DashboardLabelChangeClass
        {
            ...
            public DashboardLabelFields CarrierInsp { get; set; } = new DashboardLabelFields { Status = true, Name = "TBMCarrierInsp" };
