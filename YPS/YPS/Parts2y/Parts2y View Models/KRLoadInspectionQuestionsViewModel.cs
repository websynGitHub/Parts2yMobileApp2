...
namespace YPS.Parts2y.Parts2y_View_Models
{
    public class KRLoadInspectionQuestionsViewModel : IBase
    {
        ...
        private async Task<ObservableCollection<AllPoData>> GetUpdatedAllPOData()
        {
            ...
            {
                loadindicator = true;
                YPSLogger.TrackEvent("KRLoadInspectionQuestionsViewModel.xaml.cs", "in GetUpdatedAllPOData method " + DateTime.Now + " UserId: " + Settings.userLoginID);
        ...
        public async void QuestionClick(InspectionConfiguration inspectionConfiguration)
        {
            try
            {
                ...
                await Navigation.PushAsync(new KRInspectionAnswersPage(inspectionConfiguration, QuestionListCategory,
