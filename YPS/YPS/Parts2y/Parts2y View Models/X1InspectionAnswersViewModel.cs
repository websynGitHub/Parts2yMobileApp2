...
{
    public class X1InspectionAnswersViewModel : IBase
    {
        ...
        X1InspectionAnswersPage pagename;
        ...
        X1LoadInspectionQuestionsViewModel LoadQueVm;
        X1PartsInspectionQuestionsViewModel PartsQueVm;
        string pendingTagIDs;
        #endregion

        public X1InspectionAnswersViewModel(INavigation _Navigation, X1InspectionAnswersPage page,
            ...
            X1PartsInspectionQuestionsViewModel partsqueVm, X1LoadInspectionQuestionsViewModel loadqueVm, bool isalldone = false,
             string pendingtagIDs = null)
        {
            ...
            {
                YPSLogger.ReportException(ex, "X1InspectionAnswersViewModel constructor -> in X1InspectionAnswersViewModel.cs " + Settings.userLoginID);
        ...
        public async void QuickTabClicked()
        {
            ...
            {
                YPSLogger.ReportException(ex, "QuickTabClicked method -> in X1InspectionAnswersViewModel.cs " + Settings.userLoginID);
                var trackResult = trackService.Handleexception(ex);
            }
            finally
            {
        ...
        public async void FullTabClicked()
        {
            ...
            {
                YPSLogger.ReportException(ex, "FullTabClicked method -> in X1InspectionAnswersViewModel.cs " + Settings.userLoginID);
                var trackResult = trackService.Handleexception(ex);
            }
            finally
            {
        ...
        public async void LoadInspTabClicked()
        {
            ...
            {
                YPSLogger.ReportException(ex, "LoadInspTabClicked method -> in X1InspectionAnswersViewModel.cs " + Settings.userLoginID);
                var trackResult = trackService.Handleexception(ex);
            }
            finally
            {
        ...
        public async void SignTabClicked()
        {
            ...
            {
                YPSLogger.ReportException(ex, "SignTabClicked method -> in X1InspectionAnswersViewModel.cs " + Settings.userLoginID);
                var trackResult = trackService.Handleexception(ex);
            }
            finally
            {
        ...
        public async Task GetInspectionPhotos()
        {
            ...
            {
                YPSLogger.ReportException(ex, "GetInspectionPhotos method -> in X1InspectionAnswersViewModel.cs " + Settings.userLoginID);
                var trackResult = trackService.Handleexception(ex);
            }
            finally
            {
        ...
        public async Task ChangeLabel()
        {
                ...
                if (Settings.alllabeslvalues != null && Settings.alllabeslvalues.Count > 0)
                {
                    ...
                    if (labelval.Count > 0)
                    {
                        ...
                        else
                        {
                            ...
                            var taskanme = labelval.Where(wr => wr.FieldID.Trim().ToLower() == labelobj.TaskName.Name.Trim().ToLower()).Select(c => new { c.LblText, c.Status }).FirstOrDefault();
                            var eventname = labelval.Where(wr => wr.FieldID.Trim().ToLower() == labelobj.EventName.Name.Trim().ToLower()).Select(c => new { c.LblText, c.Status }).FirstOrDefault();
                            var load = labelval.Where(wr => wr.FieldID.Trim().ToLower() == labelobj.LoadInsp.Name.Trim().ToLower()).Select(c => new { c.LblText, c.Status }).FirstOrDefault();
                            ...
                            labelobj.LoadInsp.Name = load != null ? (!string.IsNullOrEmpty(load.LblText) ? load.LblText : labelobj.LoadInsp.Name) : labelobj.LoadInsp.Name;
            ...
            catch (Exception ex)
            {
                ...
                YPSLogger.ReportException(ex, "ChangeLabel method -> in X1InspectionAnswersViewModel.cs " + Settings.userLoginID);
            }
        }
        ...
        public async Task SelectPic()
        {
            ...
            {
                await trackService.Handleexception(ex);
                YPSLogger.ReportException(ex, "SelectPic method -> in X1InspectionAnswersViewModel.cs " + Settings.userLoginID);
            }
            finally
            {
                loadindicator = false;
        ...
        private async void NextClickMethod()
        {
            ...
            {
                await trackService.Handleexception(ex);
                YPSLogger.ReportException(ex, "NextClickMethod method -> in X1InspectionAnswersViewModel.cs " + Settings.userLoginID);
            }
            finally
            {
                loadindicator = false;
        ...
        private async void ViewallClickMethod()
        {
            ...
            {
                await trackService.Handleexception(ex);
                YPSLogger.ReportException(ex, "ViewallClickMethod method -> in X1InspectionAnswersViewModel.cs " + Settings.userLoginID);
            }
        }
        ...
        private async Task Backevnttapped_click()
        {
            ...
            {
                await trackService.Handleexception(ex);
                YPSLogger.ReportException(ex, "Backevnttapped_click method -> in X1InspectionAnswersViewModel.cs " + Settings.userLoginID);
            }
        }
        ...
        private async Task DoneClicked()
        {
            ...
            {
                YPSLogger.ReportException(ex, "DoneClicked method -> in X1InspectionAnswersViewModel.cs  " + Settings.userLoginID);
                await trackService.Handleexception(ex);
            }
        }
        ...
        private void ShowConfigurationOptions()
        {
            ...
            catch (Exception ex)
            {
                ...
                YPSLogger.ReportException(ex, "ShowConfigurationOptions method -> in X1InspectionAnswersViewModel.cs " + Settings.userLoginID);
            }
            finally
            {
